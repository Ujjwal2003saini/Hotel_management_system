...
# THIS IS ONLY FOR TABLE GENERATOR WHICH CLEAR AFTER EVERY RE-RUN
    ...
    for i in range(100):
        ...
        if xyz == "Y" or xyz == "YES":
            ...
            if win_exit == "Y" or win_exit == "YES":
                # PATH LINK
                my_image = Image.open(r"C:\Users\Us\Desktop\Ujjwal_cs project\Cs_Project\python_thankyou.png")
                my_image.show()
                exit()
                        ...
                        for children in range(customer_children): # THIS LOOP WILL TERMINATE WITH CHILDREN NUMBER
                            ...
                            try:
                                ...
                                if children_age <= 9:
                                    ...
                                    print("")
                                    print("YOUR CHILD",children_name,"CHILDREN NO.",children+1,"ENTRY IS NOT FREE")
                                    print("")
    ...
    try:
        ...
        for num_adult_customer in range(customer_adult):
            ...
            try:
                ...
                customer_gender = str(input("ENTER THE GENDER OF CUSTOMER [MALE/FEMALE/OTHER]= ")) # GENDER OF THE CUSTOMER
                ...
                str_customer_aadhaar_details = str(input("ENTER THE AADHAAR CARD NUMBER [12 DIGIT] = "))  # length of number is 12
                ...
                try:
                    ...
                    if aadhaar_length == 12:
                        aadhaar_of_customer.append(customer_aadhaar_details)  # AADHAAR IDENTIFICATION OF CUSTOMER ADDED IN THE LIST
                        aadhaar_of_the_customer.append(customer_aadhaar_details)  # AADHAAR IDENTIFICATION OF CUSTOMER ADDED IN THE LIST
                        # append function
                        print("YOUR AADHAAR NUMBER RECORDED")
                        
                        # MAKE A WRITEROWS
                        create_writer.writerow(["Name","Age","Gender","Aadhaar"])
                        create_rec = [customer_name_UPPER,customer_age,customer_gender_UPPER,customer_aadhaar_details]
                        create_writer.writerow(create_rec)
                        ...
                        str_customer_aadhaar_details = str(input("ENTER THE AADHAAR CARD NUMBER = "))  # length of number is 12
                        aadhaar_length = len(str_customer_aadhaar_details)
                        print("")
                        print("LOADING......")
                        for i in range(100):
                        ...
                        try:
                            ...
                            if aadhaar_length == 12:
                                ...
                                print("WRONG AADHAAR NUMBER SECOND TIME \n\nPLEASE RE-RUN THE PROGRAM")
                                startup()
                        except:
                ...
                print("")
                print("YOU ENTERED THE WRONG AGE [IT IS ONLY IN NUMERICALS FORM]")
                print("\nRE-RUN THE PROGRAM")
                startup()
        ...
        try:
            ...
            if customer_mobile_length == 10:
                ...
                str_customer_mobile_number = str(input("ENTER YOUR MOBILE NUMBER [10 DIGIT] = ")) # MOBILE NUMBER OF CUSTOMER 2 time
                customer_mobile_length=len(str_customer_mobile_number)
                print("")
                print("LOADING.....")
                for i in range(100):
        ...
        if customer_adult == 1:
            ...
            table = PrettyTable(["Number of customer","Name of the customer","Age","Gender","Identification","Mobile number"])
            for customer_table in range(0,customer_adult):
                table.add_row ([list1[customer_table],list2[customer_table],list3[customer_table],list4[customer_table],list5[customer_table],list6[customer_table]])
            print(table)
        ...
        # WHEN NUMBER OF CUSTOMER IS 5
            ...
            print("NUMBER OF ADULT CUSTOMERS",customer_adult)
            list1=["1","2","3","4","5"]
            list2=[name_of_customer[0],name_of_customer[1],name_of_customer[2],name_of_customer[3],name_of_customer[4]]
            list3=[age_of_customer[0],age_of_customer[1],age_of_customer[2],age_of_customer[3],age_of_customer[4]]
            list4=[gender_of_customer[0],gender_of_customer[1],gender_of_customer[2],gender_of_customer[3],gender_of_customer[4]]
            list5=[aadhaar_of_customer[0],aadhaar_of_customer[1],aadhaar_of_customer[2],aadhaar_of_customer[3],aadhaar_of_customer[4]]
            list6=[mobile_of_customer[0],mobile_of_customer[0],mobile_of_customer[0],mobile_of_customer[0],mobile_of_customer[0]]
            table = PrettyTable(["Number of customer","Name of the customer","Age","Gender","Identification","Mobile number"])
            for customer_table in range(0,customer_adult):
                table.add_row ([list1[customer_table],list2[customer_table],list3[customer_table],list4[customer_table],list5[customer_table],list6[customer_table]])
            print(table)
        # WHEN NUMBER OF CUSTOMER IS 6
            ...
            print("NUMBER OF ADULT CUSTOMERS",customer_adult)
            list1=["1","2","3","4","5","6"]
            list2=[name_of_customer[0],name_of_customer[1],name_of_customer[2],name_of_customer[3],name_of_customer[4],name_of_customer[5]]
            list3=[age_of_customer[0],age_of_customer[1],age_of_customer[2],age_of_customer[3],age_of_customer[4],age_of_customer[5]]
            list4=[gender_of_customer[0],gender_of_customer[1],gender_of_customer[2],gender_of_customer[3],gender_of_customer[4],gender_of_customer[5]]
            list5=[aadhaar_of_customer[0],aadhaar_of_customer[1],aadhaar_of_customer[2],aadhaar_of_customer[3],aadhaar_of_customer[4],aadhaar_of_customer[5]]
            list6=[mobile_of_customer[0],mobile_of_customer[0],mobile_of_customer[0],mobile_of_customer[0],mobile_of_customer[0],mobile_of_customer[0]]
            table = PrettyTable(["Number of customer","Name of the customer","Age","Gender","Identification","Mobile number"])
            for customer_table in range(0,customer_adult):
                table.add_row ([list1[customer_table],list2[customer_table],list3[customer_table],list4[customer_table],list5[customer_table],list6[customer_table]])
            print(table)
        # WHEN NUMBER OF CUSTOMER IS ELSE
            ...
            print("NUMBER OF ADULT CUSTOMERS",customer_adult)
            list1=["1","2","3","4","5","6","7"]
            list2=[name_of_customer[0],name_of_customer[1],name_of_customer[2],name_of_customer[3],name_of_customer[4],name_of_customer[5],name_of_customer[6]]
            list3=[age_of_customer[0],age_of_customer[1],age_of_customer[2],age_of_customer[3],age_of_customer[4],age_of_customer[5],age_of_customer[6]]
            list4=[gender_of_customer[0],gender_of_customer[1],gender_of_customer[2],gender_of_customer[3],gender_of_customer[4],gender_of_customer[5],gender_of_customer[6]]
            list5=[aadhaar_of_customer[0],aadhaar_of_customer[1],aadhaar_of_customer[2],aadhaar_of_customer[3],aadhaar_of_customer[4],aadhaar_of_customer[5],aadhaar_of_customer[6]]
            list6=[mobile_of_customer[0],mobile_of_customer[0],mobile_of_customer[0],mobile_of_customer[0],mobile_of_customer[0],mobile_of_customer[0],mobile_of_customer[0]]
            table = PrettyTable(["Number of customer","Name of the customer","Age","Gender","Identification","Mobile number"])
            for customer_table in range(0,customer_adult):
                table.add_row ([list1[customer_table],list2[customer_table],list3[customer_table],list4[customer_table],list5[customer_table],list6[customer_table]])
            print(table)
        ...
        if payment_method == "1":
            ...
            print("")
            # PATH LINK
            my_image = Image.open(r"D:\Ujjwal_cs project\Cs_Project\UPI qr code.png")
            my_image.show()
...
##        webbrowser.open("https://www.google.com/maps/dir/Blooming+Buds+Public+School,+B+Block,+New+Moti+Nagar,+Karampura+West,+Near+Education+Department+Office,+Phase+1,+Block+B+1,+New+Moti+Nagar,+Moti+Nagar,+New+Delhi,+Delhi+110015,+India/Taj+Palace,+New+Delhi,+Taj+Palace,+Sardar+Patel+Marg,+Diplomatic+Enclave,+Malcha,+New+Delhi,+Delhi/@28.6300416,77.1309956,13z/data=!3m1!4b1!4m13!4m12!1m5!1m1!1s0x390d03aa270562d9:0xe2dc3a221de9b12c!2m2!1d77.1424777!2d28.6643522!1m5!1m1!1s0x390d1da3d0e98c7b:0xf56c1b12e18dd9b!2m2!1d77.1709502!2d28.5951864?hl=en",new=2)
        ...
        _input_1 = (customer_name_UPPER,customer_age,customer_gender_UPPER,customer_aadhaar_details,customer_address_UPPER,customer_mobile_number,number_of_room,room_rent_after,room,room_number)
        ...
        _input_2 = (customer_check_in,month,year,check_out_date,_mon_out_,_yr_out)
        ...
        if choose_month_upper == "Y" or choose_month_upper == "YES":
            ...
            table = PrettyTable(["Name","Room Type","Number of Rooms","Check-In","Check-Out","Number of Days","Price"])
            for customer_table in range(0,6):
                table.add_row ([list1[customer_table],list2[customer_table],list3[customer_table],list4[customer_table],list5[customer_table],list6[customer_table],list7[customer_table]])
            print(table)
                ...
                # MONTH HAVING 30 DAYS
                    ...
                    try:
                        ...
                        if 1<= customer_check_in <=30:
                            ...
                            print("")
                            print("THE MAXIMUM DAYS IN MONTH WHICH YOU ENTER IS ONLY 30\nBUT YOU ENTER MORE THAN 30 DAYS")
                            print("\nRE-RUN THE PROGRAM")
                            startup()
                        else:
                            print("INVALID SYNTAX")
        ...
        try:
            ...
            if 1 <= month_out <= 12 :
                ...
                if month_out == month:
                    if year_out == year:
                        print("")
                        print("SORRY IN ABOVE STATEMENT YOU ENTER YOU CHECK-OUT THE HOTEL ROOM IN ANOTHER MONTH OF CHECK-IN")
...
def display_room():
    ...
    # PATH LINK
    my_image = Image.open(r"C:\Users\Us\Desktop\Ujjwal_cs project\Cs_Project\collage_room_1.jpeg")
    my_image.show()
    my_image = Image.open(r"C:\Users\Us\Desktop\Ujjwal_cs project\Cs_Project\collage_room_2.jpeg")
    my_image.show()
    my_image = Image.open(r"C:\Users\Us\Desktop\Ujjwal_cs project\Cs_Project\collage_room_3.jpeg")
    my_image.show()
    ...
    if room == "A":
        # PATH LINK
        my_image = Image.open(r"C:\Users\Us\Desktop\Ujjwal_cs project\Cs_Project\roomA_1.jpeg")
        my_image.show()
        my_image = Image.open(r"C:\Users\Us\Desktop\Ujjwal_cs project\Cs_Project\roomA_2.jpeg")
        my_image.show()
        my_image = Image.open(r"C:\Users\Us\Desktop\Ujjwal_cs project\Cs_Project\roomA_3.jpeg")
        my_image.show()
    ...
    #THIS IS FOR B CATEGORY OF ROOM
        ...
        # PATH LINK
        my_image = Image.open(r"C:\Users\Us\Desktop\Ujjwal_cs project\Cs_Project\roomB_1.png")
        my_image.show()
        my_image = Image.open(r"C:\Users\Us\Desktop\Ujjwal_cs project\Cs_Project\roomB_2.png")
        my_image.show()
    ...
    #THIS IS FOR C CATEGORY OF ROOM
        ...
        # PATH LINK
        my_image = Image.open(r"C:\Users\Us\Desktop\Ujjwal_cs project\Cs_Project\roomC_1.jpeg")
        my_image.show()
        my_image = Image.open(r"C:\Users\Us\Desktop\Ujjwal_cs project\Cs_Project\roomC_2.jpeg")
        my_image.show()
        my_image = Image.open(r"C:\Users\Us\Desktop\Ujjwal_cs project\Cs_Project\roomC_3.jpeg")
        my_image.show()
    ...
    #THIS IS FOR D CATEGORY OF ROOM
        ...
        # PATH LINK
        my_image = Image.open(r"C:\Users\Us\Desktop\Ujjwal_cs project\Cs_Project\roomD.png")
        my_image.show()
    ...
    #THIS IS FOR SPECIAL CATEGORY OF ROOM [DELUXE]
        ...
        # PATH LINK
        my_image = Image.open(r"C:\Users\Us\Desktop\Ujjwal_cs project\Cs_Project\special_room_deluxe_1.jpeg")
        my_image.show()
        my_image = Image.open(r"C:\Users\Us\Desktop\Ujjwal_cs project\Cs_Project\special_room_deluxe_2.jpeg")
        my_image.show()
        my_image = Image.open(r"C:\Users\Us\Desktop\Ujjwal_cs project\Cs_Project\special_room_deluxe_3.jpeg")
        my_image.show()
        my_image = Image.open(r"C:\Users\Us\Desktop\Ujjwal_cs project\Cs_Project\special_room_deluxe_4.jpeg")
        my_image.show()
        my_image = Image.open(r"C:\Users\Us\Desktop\Ujjwal_cs project\Cs_Project\special_room_deluxe_5.jpeg")
        my_image.show()
...
def indian_menu_card():
    my_image = Image.open(r"C:\Users\Us\Desktop\Ujjwal_cs project\Cs_Project\restaurant_1.jpeg")
    my_image.show()
    my_image = Image.open(r"C:\Users\Us\Desktop\Ujjwal_cs project\Cs_Project\restaurant_2.jpeg")
    my_image.show()
    my_image = Image.open(r"C:\Users\Us\Desktop\Ujjwal_cs project\Cs_Project\restaurant_3.jpeg")
    my_image.show()
    for i in range(100):
        sleep(0.05)
...
def owner_info():
    ...
    def admin_rerun():
        ...
        if owner_choice == "1": # TO CHECK GROWTH AND DEMOTE RATE OF HOTEL
            ...
            print("THESE ARE THREE OPTIONS :\n\nPRESS 1 : FOR CHECK BOOKED ROOMS\nPRESS 2 : FOR NUMBER OF STAFFS\nPRESS 3 : TO CHECK INFO OF ROOMS ITEMS")
            ...
            print("S NO.","NAME","  AGE","  GENDER","     AADHAAR","\t   ADDRESS","   PHONE NO.","NO.OF ROOMS","PRICE","ROOM CATEGORY","ROOM NUMBER")
            print("")
...
##                check_nation = nation_of_the_customer[mobile_index]
...
##                    nation_of_the_customer.remove(check_nation)  # REMOVE THE NATION
...
my_image = PIL.Image.open(r"C:\Users\Us\Desktop\Ujjwal_cs project\Cs_Project\_Taj_.png")
my_image.show()
